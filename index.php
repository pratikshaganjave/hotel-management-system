		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">SUN <span>RISE</span><p class="logo_w3l_agile_caption">Your Dream Hotel</p></a></h1>
				</div>
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
						   ...
						   <p class="about-para-w3ls">We live for vacationers and travelers who love a good deal, fun, and adventure</p>
						   <img src="images/about.jpg" class="img-responsive" alt="Hair Salon">
                                       ...
                                       <div class="w3ls-info-about">
											...
											<p>Warmth and happiness of the home you crave for </p>
										</div>
		          </div>
		   	<div class="clearfix"> </div>
    </div>
			...
			<div id="horizontalTab">
					...
					<div class="tab1">
						...
						<div class="col-md-6 team-Info-agileits">
							<h4>Pratiksha Ganjave</h4>
							<span>Developer</span>
							<p>Intuitive design is how we give the user new superpowers.One man's crappy software is another man's full time job</p>
					...
					<ul class="slides">
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>Great location, really pleasant and clean rooms, but the thing that makes this such a good place to stay are the staff. All of the people are incredibly helpful and generous with their time and advice. We travelled with two six year olds and lots of luggage and despite the stairs up to the elevator this was one of the nicest places</p>
								<h5>Gaurav Rasal</h5>
								<p>India</p>
							</div>
							<div class="clearfix"> </div>
						...
						<li>
							<div class="w3layouts_work_grid_left">
								<img src="images/5.jpg" alt=" " class="img-responsive" />
								<div class="w3layouts_work_grid_left_pos">
									<img src="images/ru.jpg" alt=" " class="img-responsive" />
								</div>
							</div>
							<div class="w3layouts_work_grid_right">
								<h4>
								...
								<p>It was very nice experience,food is so good the staff were very good and they were very good,we have nice ambience there specily biswajit vuwan anesh mamta all are very carefull on thai work i strongly recoment everyone </p>
								<h5>Rushikesh Markad</h5>
								<p>India</p>
							</div>
							<div class="clearfix"> </div>
						</li>
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>I spent a few days at this wonderful hotel! It had a combination of old world ambience and everyday comfort. The staff were so patient and kind when I practiced my Italian with them and I so much appreciated that. I will definitely return!</p>
								<h5>Rutuja patil</h5>
								<p>India</p>
							</div>
							<div class="clearfix"> </div>
						...
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>Our room was enormous, with a nice view of the river. It was 105 degrees (Fahrenheit) when we stayed but every thing was kept cool and pleasant Very centrally located. Staff were very welcoming and helpful </p>
								<h5>Sakshi Jadhav</h5>
								<p>India</p>
							</div>
							<div class="clearfix"> </div>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Address :</strong> Pccoe,pune</p>
